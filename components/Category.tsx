  ...
  return (
    <div className="mt-8">
      ...
      <div className="grid grid-cols-2 sm:flex gap-6">
        {/* Earphone Section */}
        <div className="first bg-black w-full sm:w-fit p-5 rounded-[30px] flex flex-col sm:flex-row items-center">
        ...
        {/* Watch Section */}
        <div className="first bg-yellow-400 w-full sm:w-fit p-5 rounded-[30px] flex flex-col sm:flex-row items-center">
          <div className="text-center sm:text-left">
        ...
        {/* Laptop Section */}
        <div className="first bg-red-500 w-full sm:w-[40%] p-5 rounded-[30px] flex flex-col sm:flex-row justify-between items-center">
          <div className="text-center sm:text-left">
      ...
      <div className="grid grid-cols-2 sm:flex gap-6 mt-8">
        {/* Console Section */}
        <div className="first bg-gray-200 w-full sm:w-[40%] p-5 rounded-[30px] flex flex-col sm:flex-row justify-between items-center">
          <div className="text-center sm:text-left">
          ...
          <div className="mt-4 sm:mt-0">
            <Image
              ...
              width={200}
              height={200}
              className="h-[150px] w-[150px] sm:h-[300px] sm:w-[200px] object-cover"
            />
          </div>
        </div>

        {/* Oculus Section */}
        <div className="first bg-green-400 w-full sm:w-fit p-5 rounded-[30px] flex flex-col sm:flex-row items-center">
          <div className="text-center sm:text-left">
        ...
        {/* Bluetooth Section */}
        <div className="first bg-blue-500 w-full sm:w-fit p-5 rounded-[30px] flex flex-col sm:flex-row items-center">
          <div className="text-center sm:text-left">
          ...
          <div className="mt-4 sm:mt-0">
            <Image
              ...
              width={200}
              height={200}
              className="h-[150px] w-[150px] sm:h-[300px] sm:w-[300px] object-contain"
            />
          </div>
        </div>
      </div>
