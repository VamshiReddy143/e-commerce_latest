  ...
  return (
    <div className="flex items-center justify-center w-fit h-fit">
      <div className="w-[200px] h-[100px] flex flex-col relative items-center justify-end overflow-x-hidden">
        ...
        {/* Truck Tires */}
        <div className="w-[130px] absolute bottom-0 flex items-center justify-between px-[10px] pl-[15px]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 30 30"
        ...
        {/* Road */}
        <div className="truck-road w-full h-[1.5px] bg-[#282828] relative rounded-[3px]" />
